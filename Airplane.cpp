...
private:
    ...
    gps::BoundingBox boundingBox; // Airplane bounding box    
...
public:
    Airplane(glm::vec3 startPosition, glm::mat4 initialModelMatrix, GLuint shaderModelLoc, gps::BoundingBox initialBoundingBox, float groundY = 3.0f, float gravityAccel = -9.8f)
        ...
        modelMatrix(initialModelMatrix), modelMatrixLoc(shaderModelLoc), boundingBox(initialBoundingBox), groundLevel(groundY), speed(0.0f),
    ...
    void updateModelMatrix() {
        ...
        modelMatrix = glm::rotate(modelMatrix, glm::radians(roll), glm::vec3(0.0f, 1.0f, 0.0f));
    }
    ...
    gps::BoundingBox getBoundingBox() const{
        return boundingBox;
    }
};
